...
<div class="user-bm" id="main_message">

  <div class="title-email">邮箱注册</div>
  <div class="title-sub">如果您已拥有账号，请在此直接<a href="#nogo">登录</a></div>
...
<table>
<tr>
<th><span class="rq">*</span><label for="<?php echo $this->setting['reginput']['email'];?>">常用邮箱:</label></th>
<td>
...
<div class="rfm a_password">
<table>
<tr>
<th><span class="rq"></span><label for="<?php echo $this->setting['reginput']['password'];?>">登录密码:</label></th>
...
<td class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['password2'];?>" class="p_tip">请再次输入密码</i><kbd id="chk_<?php echo $this->setting['reginput']['password2'];?>" class="p_chk"></kbd></td>
               ...
               <!--用户名-->
<div class="rfm a_user">
<table>
<tr>
<th><span class="rq"></span><label for="<?php echo $this->setting['reginput']['username'];?>">昵&nbsp;&nbsp;&nbsp;&nbsp;称:</label></th>
...
<?php } ?>
    ...
    <div>点击注册表示您已经同意<a href="#nogo">用户协议</a>和<a href="#nogo">隐私保护</a></div>
</form>
<?php } ?>
