...
0
|| checktplrefresh('data/diy/./template/default//forum/discuz.htm', './template/default/common/header.htm', 1358300763, 'diy', './data/template/1_diy_forum_discuz.tpl.php', 'data/diy/./template/default/', 'forum/discuz')
|| checktplrefresh('data/diy/./template/default//forum/discuz.htm', './template/default/common/footer.htm', 1358300763, 'diy', './data/template/1_diy_forum_discuz.tpl.php', 'data/diy/./template/default/', 'forum/discuz')
|| checktplrefresh('data/diy/./template/default//forum/discuz.htm', './template/default/common/header_common.htm', 1358300763, 'diy', './data/template/1_diy_forum_discuz.tpl.php', 'data/diy/./template/default/', 'forum/discuz')
|| checktplrefresh('data/diy/./template/default//forum/discuz.htm', './template/default/common/pubsearchform.htm', 1358300763, 'diy', './data/template/1_diy_forum_discuz.tpl.php', 'data/diy/./template/default/', 'forum/discuz')
;
block_get('3');?>
...
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framePnoIR5" class="frame move-span cl frame-1-1"><div class="title frame-title"><span class="titletext">1-1框架</span></div><div id="framePnoIR5_left" class="column frame-1-1-l"><div id="framePnoIR5_left_temp" class="move-span temp"></div><?php block_display('3');?></div><div id="framePnoIR5_center" class="column frame-1-1-r"><div id="framePnoIR5_center_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
<?php } ?>
